...
var Estudiante = /*#__PURE__*/function (_Usuario) {
  ...
  function Estudiante(carrera, nombre, edad, correo) {
    var _this;
...
var beneharo = new Usuario('Beneharo Bentor', 21, 'correo@correo.com');
document.write(beneharo.mostrarInfo());
var alejandro = new Estudiante('Alejandro', 23, 'correo2@correo.com', 'Informatica');
